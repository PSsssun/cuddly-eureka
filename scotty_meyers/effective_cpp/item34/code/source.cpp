...
int main()
{
    std::cout << "Item 34: Differentiate between inheritance of interface and  inheritance of implemtation.\n";
    ...
    ModelA().fly(Airport("Shanghai Pudong IA"));
    ModelB().fly(Airport("Peking CIA"));
