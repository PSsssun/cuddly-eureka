...
int main()
{
    // stringArray1 points to enough memory for 10 string objects,
    // but no objects have been constructed in taht memory. Furthermore, you have
    // no way to initialize the objects in the array. In other words, stringArray1 is
    // pretty useless.
    string *stringArray1 = 
