...
void Set<T>::remove(const T& item) {
    typename std::list<T>::iterator it = // This tells the compiler that when the function template is used later its argument will always be something for which Container::iterator is a type.
...
int main() {
    std::cout << "Item 38: Model has a or is implemented-in-terms of throught composition.\n";
