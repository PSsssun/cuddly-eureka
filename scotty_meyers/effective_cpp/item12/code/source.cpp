...
class Customer {
public:
    Customer():name_("") {std::cout << "base constructor" << std::endl;}
...
public:
    PriorityCustomer(const int n) :priority_(n){std::cout << "derived constructor" << std::endl;};
...
int main() {
    ...
    Customer cus1 = cus;
    cus = cus1;
    PriorityCustomer bob(17);
    PriorityCustomer simon = bob;
    bob = simon;
    return 0;
}
